...
- (CGFloat)widthWithIndexPath:(NSIndexPath *)indexPath height:(CGFloat)height
{
    Model *model = [self.modArr objectAtIndex:indexPath.row];
    
    CGFloat width = height / ([model.height doubleValue] / [model.width doubleValue]);
    return width;
